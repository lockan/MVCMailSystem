...
namespace MVCMailSystem.Models
{
    ...
    {
        //Composite Primary key 1: mailboxID is the recipient's employeeID from employee table. 
        public Guid                 MailBoxID   { get; set; }   
        
        // Composite Primary key 2: messageID is the messageID from the Message table.  
