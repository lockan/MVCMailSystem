        ...
        public ActionResult Index()
        {
            ...
            */
            ...
            try
            {
                ...
                string myid = this.Session["RecipientID"].ToString();
               ...
               // Employeelist = db.empDB.ToList(); // use senderID to get firstname
                string sqlstatement = "SELECT Mails.*, MailBoxes.*, Employees.firstname FROM MailBoxes, Mails, Employees WHERE MailBoxes.RecipientID = '" +
